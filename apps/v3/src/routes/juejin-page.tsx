            ...
            >
              ...
              >
                ...
                <View style={{ flexDirection: "row", alignItems: "center", height: "100%" }}>
                  <View style={{ marginRight: 24, cursor: "pointer", justifyContent: "center" }}>
                    <Image
              ...
              <ScrollView style={{ flex: 1, width: vw }}>
                ...
                >
                  ...
                  <View style={{ flex: 1, maxWidth: 720 }}>
                    <View style={{ backgroundColor: "#ffffff", borderRadius: 4, marginBottom: 8 }}>
                      <View
                        style={{
                          flexDirection: "row",
                          alignItems: "center",
                        ...
                        {[
                          ...
                          >
                            ...
                            >
                              ...
                              />
                              <Text style={{ fontSize: 13, color: "#86909c" }}>{article.time}</Text>
                              <View
                                style={{
                                  width: 1,
                                  height: 12,
                              ...
                              />
                              <Text style={{ fontSize: 13, color: "#86909c" }}>{article.tag}</Text>
                            </View>
                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                              <View style={{ flex: 1, paddingRight: 16, flexDirection: "column" }}>
                                <Text
                                  style={{
                                    fontSize: 16,
                                    fontWeight: 600,
                  ...
                  {vw >= 1280 && (
                    <View
                      style={{ width: 260, flexShrink: 0, marginLeft: 16, flexDirection: "column" }}
                    >
                      {/* Sign In Card */}
                      <View
                        style={{
                      ...
                      >
                        ...
                        <Text style={{ fontSize: 12, color: "#86909c" }}>点亮在社区的每一天</Text>
                      </View>
                      ...
                      >
                        ...
                        <View style={{ flexDirection: "column", gap: 16 }}>
                          {[
                            { num: "1", color: "#f53f3f", title: "别让压图压垮首帧：系统 Pick..." },
                            { num: "2", color: "#ff7d00", title: "XChat 为什么选择 Rust 语言..." },
                            { num: "3", color: "#ffcf00", title: "HTML-in-Canvas：让 Canvas..." },
                            { num: "4", color: "#86909c", title: "从考研到前端转型AI agent直..." },
                            { num: "5", color: "#86909c", title: "我的 2026 全栈选型：Vue3 +..." },
                          ].map((item) => (
                            <View
                              key={item.num}
                              style={{
                            ...
                            >
                              ...
                              <Text style={{ color: "#1d2129", fontSize: 14 }}>{item.title}</Text>
                            </View>
                          ))}
                        </View>
                        <View
